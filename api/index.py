...
default = {
    ...
    'dyk_prompt': os.environ.get("FEEDSUMMARIZER_DYK_INSTRUCTION", "Analyze this article and evaluate its relevance for a corporate Learning & Development (L&D) / HR monthly newsletter. Explain why an HR professional or team lead would include it, what key learning takeaway or employee upskilling value it offers, and how teams can apply it in 2 to 3 sentences."),
