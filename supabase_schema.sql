...
-- ALTER TABLE articles ADD COLUMN IF NOT EXISTS ld_score INT;
-- ALTER TABLE articles ADD COLUMN IF NOT EXISTS ld_tag TEXT;
-- ALTER TABLE articles ADD COLUMN IF NOT EXISTS ld_insight TEXT;
--
